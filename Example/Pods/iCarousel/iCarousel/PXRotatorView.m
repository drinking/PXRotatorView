...
- (NSUInteger)numberOfPlaceholdersInCarousel:(__unused PXRotatorView *)carousel { return 0; }
- (void)carouselWillBeginScrollingAnimation:(__unused PXRotatorView *)carousel {}
- (void)carouselDidEndScrollingAnimation:(__unused PXRotatorView *)carousel {}
- (void)carouselDidScroll:(__unused PXRotatorView *)carousel {}

- (void)carouselCurrentItemIndexDidChange:(__unused PXRotatorView *)carousel {}
- (void)carouselWillBeginDragging:(__unused PXRotatorView *)carousel {}
- (void)carouselDidEndDragging:(__unused PXRotatorView *)carousel willDecelerate:(__unused BOOL)decelerate {}
- (void)carouselWillBeginDecelerating:(__unused PXRotatorView *)carousel {}
- (void)carouselDidEndDecelerating:(__unused PXRotatorView *)carousel {}

- (BOOL)carousel:(__unused PXRotatorView *)carousel shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)carousel:(__unused PXRotatorView *)carousel didSelectItemAtIndex:(__unused NSInteger)index {}

- (CGFloat)carouselItemWidth:(__unused PXRotatorView *)carousel { return 0; }
- (CATransform3D)carousel:(__unused PXRotatorView *)carousel
   itemTransformForOffset:(__unused CGFloat)offset
            baseTransform:(CATransform3D)transform { return transform; }
- (CGFloat)carousel:(__unused PXRotatorView *)carousel
...
NSComparisonResult compareViewDepth(UIView *view1, UIView *view2, PXRotatorView *self);
